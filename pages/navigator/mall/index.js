...
Page({
  ...
  async initBottomSpuList(){
    ...
    const paging = SpuPaging.getLatestPaging(obj);
    ...
    wx.lin.renderWaterFlow(data.items);//lin-ui  瀑布流函数
  },
  initAllData() {
    //TODO:真实数据
  ...
  json5: {
    ...
    "spu_list": [{
        "id": 25,
        "title": "复古双色沙发",
      "subtitle": "双色可选，经典青黄两色sadfadsfasdfasdfaadfadsfasdfasdfasdadfadsfasdfasdfasdadfadsfasdfasdfasdadfadsfasdfasdfasdsd",
        "category_id": 35,
        "root_category_id": 4,
        "price": "3999",
