  ...
  return function(t) {
    ...
    var n = i(46),
      r = {
        ...
        isObjectValueEqual: function(t, e) {
          t = ÏObject.assign({}, t), e = Object.assign({}, e);
        ...
        parsePadding: function(t) {
          var e, i, n, a;
          return r.isNumber(t) || r.isString(t) ? e = n = a = i = t : r.isArray(t) && (e = t[0], i = r.isNil(t[1]) ? t[0] : t[1], n = r.isNil(t[2]) ? t[0] : t[2], a = r.isNil(t[3]) ? i : t[3]), [e, i, n, a]
        },
    ...
    t.exports = {
      getBBoxFromPoints: function(t, e) {
        if (0 !== t.length) {
          for (var i = t[0], n = i.x, r = i.x, a = i.y, o = i.y, s = t.length, c = 1; c < s; c++) i = t[c], n = Math.min(n, i.x), r = Math.max(r, i.x), a = Math.min(a, i.y), o = Math.max(o, i.y);
          return e = e / 2 || 0, {
            minX: n - e,
            minY: a - e,
            maxX: r + e,
      ...
      getBBoxFromArc: function(t, e, i, n, r, a) {
        var u = Math.abs(n - r);
        if (u % (2 * Math.PI) < 1e-4 && u > 1e-4) return {
          minX: t - i,
          minY: e - i,
          maxX: t + i,
          maxY: e + i
    ...
    var c = i(33),
      ...
      m = function(t) {
        ...
        return i.getDefaultCfg = function() {
          ...
          }), i = Math.min.apply(null, i), n = Math.max.apply(null, n), u.each(e, function(t) {
            t.change({
              min: i
            }), t.change({
              max: n
          ...
          return u.isObject(t) ? u.mix(i, t) : i[t] = e, this.set("colDefs", i), this.get("scaleController").defs = i, this
        }, i.axis = function(t, e) {
          var i = this.get("axisController");
          return t ? (i.axisCfg = i.axisCfg || {}, i.axisCfg[t] = e) : i.axisCfg = null, this
        }, i.coord = function(t, e) {
          var i;
          return u.isObject(t) ? i = t : (i = e || {}).type = t || "cartesian", this.set("coordCfg", i), this
          ...
          this.clear(), this.get("canvas").destroy(), e.plugins.notify(this, "afterCanvasDestroyed"), this._interactions && u.each(this._interactions, function(t) {
            t.destroy()
          ...
          var t = this.get("geoms"),
            e = [];
          return u.each(t, function(t) {
            var i = t.getYScale(); - 1 === e.indexOf(i) && e.push(i)
          }), e
          ...
          var i = this,
            n = i.get("plugins") || [];
          u.isArray(n) || (n = [n]), [].concat(t).forEach(function(t) {
          ...
          return u.isArray(t) ? -1 !== t.indexOf("auto") : "auto" === t
      ...
      r = {
        ...
        splitArray: function(t, e, i) {
          ...
          return n.each(t, function(t) {
            r = t._origin ? t._origin[e] : t[e], i ? n.isNil(r) || o.push(t) : n.isArray(r) && n.isNil(r[0]) || n.isNil(r) ? o.length && (a.push(o), o = []) : o.push(t)
          }), o.length && a.push(o), a
        }
      };
    t.exports = r
    ...
    var i = {
      ...
      scale: function(t, e, i) {
        return t[0] = e[0] * i[0], t[1] = e[1] * i[0], t[2] = e[2] * i[1], t[3] = e[3] * i[1], t[4] = e[4], t[5] = e[5], t
      },
      ...
      translate: function(t, e, i) {
        return t[0] = e[0], t[1] = e[1], t[2] = e[2], t[3] = e[3], t[4] = e[4] + e[0] * i[0] + e[2] * i[1], t[5] = e[5] + e[1] * i[0] + e[3] * i[1], t
      },
        ...
        return e._initDefaultCfg = function() {
          ...
          n.each(i, function(i) {
            ...
            i.attr(n.mix({
              x: s,
              y: c
            }, t.getTextAlignInfo(a, e), i.get("textStyle"))), i._id = t._id + "-" + i.attr("text"), r.add(i)
          })
    ...
    var r = i(0),
      ...
      h = function() {
        ...
        return e._initProperties = function() {
          ...
          return t && u.indexOf(t._attrs.type) > -1 ? (null === t.get("canvas") && (t = Object.assign({}, t)), t.set("parent", this.get("parent")), t.set("context", this.get("context")), t) : null
        }, e.attr = function(t, e) {
          var i = this;
          ...
          return 2 === n ? (this._attrs.bbox = null, i._setAttr(t, e), i._afterAttrsSet && i._afterAttrsSet(), i) : i._getAttr(t)
    ...
    var r = i(12),
      ...
      l = function(t) {
        ...
        return i._initDefaultCfg = function() {
          ...
          return -1 === this.values.indexOf(e) && s(e) && (e = this.values[Math.round(e)]), t.prototype.getText.call(this, e)
    ...
    t.exports = function(t) {
      ...
      if (o ? 2 === (e = r(c - 1, l - 1) + 1) ? e = l : e < l - 4 && (e = l - 4) : e = l, !o && c <= e + e / 2) a = [].concat(s);
        ...
        for (var u = parseInt(c / (e - 1), 10), h = s.map(function(t, e) {
            return e % u == 0 ? s.slice(e, e + u) : null
          }).filter(function(t) {
            return t
          }), f = 1, p = h.length; f < p && (o ? f * u < c - u : f < e - 1); f++) a.push(h[f][0]);
        if (s.length) {
          a.unshift(s[0]);
          var g = s[c - 1]; - 1 === a.indexOf(g) && a.push(g)
        }
      }
    ...
    t.exports = {
      smooth: function(t, e, i) {
        for (var n, a, o, s = !!e, c = r(t, .4, s, i), l = t.length, u = [], h = 0; h < l - 1; h++) n = c[2 * h], a = c[2 * h + 1], o = t[h + 1], u.push(["C", n[0], n[1], a[0], a[1], o.x, o.y]);
        return s && (n = c[l], a = c[l + 1], o = t[0], u.push(["C", n[0], n[1], a[0], a[1], o.x, o.y])), u
      }
    }
  }, function(t, e, i) {
    function n(t, e) {
    ...
    var s = function(t) {
      ...
      return i.getDefaultCfg = function() {
        ...
        l.origin = t, o.each(c, function(r, a) {
          l.splitedIndex = a, l.points = r, i.drawShape(l.shape, t[0], l, n, e)
        })
      }, e
    }(r);
    ...
    var n = {},
      r = i(1);
    n.Global = r, n.version = r.version, n.Chart = i(15), n.Shape = i(8), n.G = i(5), n.Util = i(0), n.track = function() {
      return null
    }, t.exports = n
  }, function(t, e, i) {
    var n = i(0),
    ...
    r = {
      ...
      getRelativePosition: function(t, e) {
        var i = e.get("el"),
          ...
          f = e.get("pixelRatio");
        return {
          x: (t.x - s - c) / u * i.width / f,
          y: (t.y - r - l) / h * i.height / f
        }
      },
      addEventListener: function(t, e, i) {
        r.isBrowser && t.addEventListener(e, i, a)
      },
      removeEventListener: function(t, e, i) {
        r.isBrowser && t.removeEventListener(e, i, a)
      },
      createEvent: function(t, e) {
        return n(t, e)
      },
      measureText: function(t, e, i) {
        return i || (i = document.createElement("canvas").getContext("2d")), i.font = e || "12px sans-serif", i.measureText(t)
      }
    }, t.exports = r
  }, function(t, e, i) {
    var n = i(29);
    ...
    var r = i(9),
      ...
      s = function(t) {
        function e(e) {
          var i;
          return i = t.call(this, e) || this, i.names = ["x", "y"], i.type = "position", i
        }
        return n(e, t), e.prototype.mapping = function(t, e) {
          ...
          if (a(e) && a(t)) {
            i = [], n = [];
            for (var f = 0, p = 0, g = t.length, d = e.length; f < g && p < d; f++, p++) s = l.convertPoint({
              x: u.scale(t[f]),
              y: h.scale(e[p])
            }), i.push(s.x), n.push(s.y)
          } else if (a(e)) t = u.scale(t), n = [], o(e, function(e) {
            e = h.scale(e), s = l.convertPoint({
              x: t,
              y: e
            }), i && i !== s.x ? (a(i) || (i = [i]), i.push(s.x)) : i = s.x, n.push(s.y)
          });
          else if (a(t)) e = h.scale(e), i = [], o(t, function(t) {
            t = u.scale(t), s = l.convertPoint({
              x: t,
              y: e
    ...
    var r = function(t) {
      function e(e) {
        var i;
        return i = t.call(this, e) || this, i.names = ["shape"], i.type = "shape", i.gradient = null, i
      }
    ...
    var r = function(t) {
      function e(e) {
        var i;
        return i = t.call(this, e) || this, i.names = ["size"], i.type = "size", i.gradient = null, i
      }
      return n(e, t), e
    }(i(14));
    t.exports = r
    ...
    var r = i(0),
      ...
      o = function(t) {
        function e(e) {
          var i;
          return i = t.call(this, e) || this, i.names = ["color"], i.type = "color", i.gradient = null, r.isString(i.values) && (i.linear = !0), i
        }
        return n(e, t), e.prototype.getLinearValue = function(t) {
          var e = this.gradient;
          if (!e) {
    ...
    var c = i(0),
      ...
      u = {
        toHex: function(t) {
          ...
          return i.shift(), i = r(i), l[t] = i, i
        },
        hex2arr: s,
        gradient: function(t) {
          var e = [];
          return c.isString(t) && (t = t.split("-")), c.each(t, function(t) {
              -1 === t.indexOf("#") && (t = u.toHex(t)), e.push(s(t))
            }),
            function(t) {
              return o(e, t)
            }
    ...
    var n = i(0),
      ...
      s = function() {
        ...
        return e._getDef = function(t) {
          ...
          var c = e[0][t];
          if (null === c && (c = n.Array.firstValue(e, t)), n.isNumber(t) || n.isNil(c) && !s) i = new a.Identity({
            value: t,
            field: t.toString(),
            values: [t]
          });
    ...
    var r = i(2),
      ...
      o = function(t) {
        ...
        var i = e.prototype;
        return i._initProperties = function() {
          t.prototype._initProperties.call(this), this._attrs.canStroke = !0, this._attrs.canFill = !0, this._attrs.type = "arc"
        }, i.getDefaultAttrs = function() {
          return {
            x: 0,
            y: 0,
    ...
    var c = function(t) {
      function e(e) {
        var i;
        return i = t.call(this, e) || this, o.mix(n(i), s), i
      }
      r(e, t);
      var i = e.prototype;
      return i.getDefaultCfg = function() {
    ...
    function n(t) {
      ...
      var c, l;
      return a.isArray(e) ? (c = e[0], l = e[1]) : (c = e - r / 2, l = e + r / 2), [{
        x: c,
        y: o
      }, {
        x: c,
    ...
    t.exports = {
      toTimeStamp: function(t) {
        return n(t) && (t = t.indexOf("T") > 0 ? new Date(t).getTime() : new Date(t.replace(/-/gi, "/")).getTime()), r(t) && (t = t.getTime()), t
      }
    }
  }, function(t, e, i) {
    function n(t, e) {
    ...
    var r = i(0),
      a = {
        ...
        square: function(t, e, i, n) {
          n.moveTo(t - i, e - i), n.lineTo(t + i, e - i), n.lineTo(t + i, e + i), n.lineTo(t - i, e + i), n.closePath()
        }
      },
      o = function(t) {
        function e() {
        ...
        return e.getDefaultCfg = function() {
          ...
          if (t) {
            ...
            var l = n.mix({
              ...
              u = this.backShape;
            u ? u.attr(l) : u = e.addShape("Rect", {
              zIndex: -1,
              attrs: l
            }), this.backShape = u, e.sort()
          }
          ...
          for (var t, e, i = this.maxLength, n = this.itemsGroup.get("children"), r = this.itemGap, a = this.itemMarginBottom, o = this._titleHeight, s = 0, c = 0, l = this._getMaxItemWidth(), u = [], h = 0, f = n.length; h < f; h++) {
            var p = n[h],
              ...
              d = g.height,
              v = g.width;
            e = d + a, (t = l || v) - (i - c) > 1e-4 && (s++, c = 0), p.moveTo(c, s * e), u.push({
              x: c,
              y: s * e + o - d / 2,
              width: 1.375 * v,
              height: 1.375 * d
          ...
          for (var t, e, i = this.maxLength, r = this.itemsGroup, a = this.itemGap, o = this.itemMarginBottom, s = this.itemWidth, c = this._titleHeight, l = r.get("children"), u = 0, h = 0, f = 0, p = [], g = 0, d = l.length; g < d; g++) {
            var v = l[g],
              y = v.getBBox();
            t = y.width, e = y.height, n.isNumber(s) ? h = s + a : t > h && (h = t + a), i - u < e ? (u = 0, f += h, v.moveTo(f, 0), p.push({
              x: f,
              y: c - e / 2,
              width: 1.375 * t,
              height: 1.375 * e
    ...
    var n = i(5).Matrix,
      ...
      a = {
        ...
        getAnimateParam: function(t, e, i) {
          var n = {};
          return t.delay && (n.delay = r.isFunction(t.delay) ? t.delay(e, i) : t.delay), n.easing = t.easing, n.duration = t.duration, n.delay = t.delay, n
        },
    ...
    t.exports = {
      ...
      getLimitRange: function(t, e) {
        ...
        return "linear" === o ? (i = r.Array.getRange(s), e.min < i.min && (i.min = e.min), e.max > i.max && (i.max = e.max)) : "timeCat" === o ? (r.each(s, function(t, e) {
          s[e] = n.toTimeStamp(t)
        }), s.sort(function(t, e) {
          return t - e
        }), i = s) : i = s, i
        ...
        r.each(t, function(t) {
          ...
          if (r.isArray(t.y)) {
            ...
            r.each(t.y, function(r, c) {
              o.y = r, s && 0 === c || i.drawShape(a, t, o, n, e)
            })
    ...
    function r(t, e, i) {
      if (0 !== t.size) {
        ...
        for (var l = 0, u = c.length; l < u; l++) return "rect" === i ? e.addShape("Rect", {
          className: "point",
          attrs: a.mix({
            x: s - o,
            y: c[l] - o,
    ...
    var l = i(0),
      ...
      d = ["area", "smooth"];
    l.each(d, function(t) {
      u.registerShape("area", t, {
        draw: function(e, i) {
          var n = "smooth" === t;
          return c.call(this, e, i, n)
        }
      })
    }), t.exports = g
  }, function(t, e, i) {
    ...
    var r = i(12),
      ...
      p = function(t) {
        ...
        return i._initDefaultCfg = function() {
          ...
          var e = this.values.indexOf(t);
          return -1 === e && (e = u(t) && t < this.values.length ? t : NaN), e
        }, i.scale = function(t) {
          var e, i = this.rangeMin(),
            n = this.rangeMax(),
            r = this.translate(t);
    ...
    ! function(r) {
      ...
      var _ = {
        ...
        S = {
          ...
          Do: [new RegExp(u.source + p.source), function(t, e) {
            t.day = parseInt(e, 10)
          }],
          M: [u, function(t, e) {
            t.month = e - 1
    ...
    function r(t, e, i, n) {
      var r = [];
      return "left" === t && "top" === e ? (r[0] = 0, r[1] = 0) : "right" === t && "top" === e ? (r[0] = -i, r[1] = 0) : "left" === t && "bottom" === e ? (r[0] = 0, r[1] = Math.floor(-n)) : "right" === t && "bottom" === e ? (r[0] = Math.floor(-i), r[1] = Math.floor(-n)) : "right" === t && "middle" === e ? (r[0] = Math.floor(-i), r[1] = Math.floor(-n / 2)) : "left" === t && "middle" === e ? (r[0] = 0, r[1] = Math.floor(-n / 2)) : "center" === t && "bottom" === e ? (r[0] = Math.floor(-i / 2), r[1] = Math.floor(-n)) : "center" === t && "top" === e ? (r[0] = Math.floor(-i / 2), r[1] = 0) : (r[0] = Math.floor(-i / 2), r[1] = Math.floor(-n / 2)), r
    }
      ...
      l = function(t) {
        ...
        return i._initDefaultCfg = function() {
          ...
          if (n) {
            ...
            n.x = n.x + m[0] + p, n.y = n.y + m[1] + f, v && (n.x += v), y && (n.y += y), a(c, {
              top: Math.floor(n.y) + "px",
              left: Math.floor(n.x) + "px",
              visibility: "visible"
            }), i.element = h
    ...
    var r = i(0),
      ...
      o = function(t) {
        ...
        return i._initDefaultCfg = function() {
          ...
          var i = [];
          if (i[0] = this.parsePoint(t, this.start), i[1] = this.parsePoint(t, this.end), i[0] && i[1]) {
    ...
    function r(t, e) {
      ...
      if (a.length && u.each(a, function(t) {
          return r = t, !1
        }), r) {
        var o = r.field;
        i = r.getText(e[o])
    ...
    function s(t, e) {
      ...
      return u.each(t, function(t, n) {
        if (t.title === e.title && t.name === e.name && t.value === e.value && t.color === e.color) return i = n, !1
      }), i
    }
    ...
    function c(t) {
      var e = [];
      return u.each(t, function(t) {
        var i = s(e, t); - 1 === i ? e.push(t) : e[i] = t
      }), e
    }
    ...
    var g = function() {
      ...
      return e._setCrosshairsCfg = function() {
        var t = this.chart,
          ...
          n = [];
        u.each(i, function(t) {
          var e = t.get("type"); - 1 === n.indexOf(e) && n.push(e)
        });
        var r = t.get("coord").type;
        return !i.length || "cartesian" !== r && "rect" !== r || 1 === n.length && -1 !== ["line", "area", "path", "point"].indexOf(n[0]) && u.mix(e, {
          showCrosshairs: !0
        }), e
        ...
        if ("rect" === i) {
          var a, o, s, c, l = this.chart,
            ...
            v = n[n.length - 1],
            y = d.width;
          g.transposed ? (a = f.x, o = v.y - .75 * y, s = p.x - f.x, c = d.y - v.y + 1.5 * y) : (a = d.x - .75 * y, o = f.y, s = v.x - d.x + 1.5 * y, c = p.y - f.y), t.style = u.mix({
            x: a,
            y: o,
            width: s,
            height: c,
        ...
        if (a.onShow && a.onShow({
            ...
            items: e,
            tooltipMarkerCfg: i
          }), l(n, e)) !1 === f && (u.directionEnabled(a.crosshairsType, "y") || a.showYTip) && this.chart.get("canvas").draw();
        else {
          this._lastActive = e;
          var m = a.onChange;
          m && m({
            ...
            if (n.get("visible")) {
              ...
              u.each(f, function(t) {
                if (t.x && t.y) {
                  ...
                  }, i)), l.push(y), -1 !== ["line", "area", "path"].indexOf(s) ? (e = "circle", c.push(y)) : "interval" !== s || "cartesian" !== g.type && "rect" !== g.type || (e = "rect", y.width = n.getSize(t._origin), c.push(y))
                }
              })
            }
          }), l.length) {
        ...
        u.each([].concat(t), function(t) {
          "bind" === i ? u.addEventListener(n, t, e) : u.removeEventListener(n, t, e)
        })
    ...
    t.exports = {
      init: function(t) {
        ...
        t.set("tooltipController", e), t.tooltip = function(t, i) {
          return u.isObject(t) && (i = t, t = !0), e.enable = t, i && (e.cfg = i), this
        }
      },
        ...
        return e.getDefaultCfg = function() {
          ...
          if (!n.isNil(t)) {
            ...
            i.attr({
              ...
              width: l,
              height: u
            }), this._width = l, this._height = u, this.content = t.text
          }
    ...
    var o = function() {
      function t(t) {
        this.guides = [], this.xScale = null, this.yScales = null, this.guideShapes = [], n.mix(this, t)
      }
      var e = t.prototype;
      return e._toString = function(t) {
        ...
        n.each(r, function(n, r) {
          ...
          if (l) {
            var u = e._getId(l, n);
            [].concat(l).forEach(function(t) {
              t._id = t.get("className") + "-" + u, t.set("index", r), s.push(t)
            })
          }
        }), e.guideShapes = s
      }, e.clear = function() {
    ...
    var c = function() {
      ...
      return e.addLegend = function(t, e, i) {
        ...
        var u = new a(r.deepMix({}, o.legend[n], i, {
        ...
        var g = r.deepMix({}, o.legend[i], c[f] || c, {
              ...
              r.each(e, function(e) {
                ...
                if (s.length) {
                  ...
                  r.each(o, function(r, a) {
                    if (t >= r.x + c && t <= r.x + r.width + c && i >= r.y + l && i <= r.height + r.y + l) return n = {
                      clickedItem: s[a],
                      clickedLegend: e
                    }, !1
                  })
        ...
        if (a && !1 !== a.clickedLegend.clickable) {
          ...
          if (s.onClick) t.clickedItem = o, s.onClick(t);
            ...
            "single" === s.selectedMode ? i.filter(h, function(t) {
              return t === l
            }) : (c ? r.Array.remove(u, l) : u.push(l), i.filter(h, function(t) {
    ...
    t.exports = {
      init: function(t) {
        ...
        t.set("legendController", e), t.legend = function(t, i) {
          var n = e.legendCfg;
          return e.enable = !0, r.isBoolean(t) ? (e.enable = t, n = i || {}) : r.isObject(t) ? n = t : n[t] = i, e.legendCfg = n, this
        }
      },
    ...
    function a(t, e, i) {
      ...
      return f.each(t, function(t, a) {
        ...
        !1 !== c && f.each(o, function(e, o) {
          e.get("className") === s && (e._id = r(t, e.get("origin")._origin, a), e.set("coord", i), e.set("animateCfg", c), e.set("index", o), n.push(e))
        }), t.set("shapes", o)
      }), n
    }
    ...
    function l(t, e, i) {
      ...
      f.each(e, function(e) {
        ...
        Object.keys(l).length && (r = s(e, i, "update", a.animation), f.isFunction(r) ? r(t, a, i) : (t.attr(o), t.animate().to({
          attrs: l,
          duration: a.duration,
          easing: a.easing,
          delay: a.delay
    ...
    var o = i(130),
      s = function() {
        function t(t, e, i) {
          this.hasStarted = !1, this.hasEnded = !1, this.shape = t, this.source = e, this.timeline = i, this.animate = null
        }
        var e = t.prototype;
    ...
    function r(t, e, i) {
      for (var n, r, o, s = t.get("children"), c = 0, l = s.length; c < l; c++) {
        var u = s[c],
          h = u.getBBox();
        n = (h.minX + h.maxX) / 2, r = (h.minY + h.maxY) / 2, o = a.getScaledMatrix(u, [n, r], i), a.doAnimation(u, {
          matrix: o
        }, e)
      }
    }
    ...
    t.exports = {
      _bindPress: function() {
        ...
        o && o.enable && (t.set("_closeTooltip", !0), e ? (e.get("press").set({
          threshold: r,
          time: a
        ...
        if (e) {
          ...
          if (r.directionEnabled(l, "x")) {
            ...
            _ ? _.get("children")[1].attr({
              x1: Math.max(a.bl.x + a.width * x[0] + h, a.bl.x),
              x2: Math.min(a.bl.x + a.width * x[1] + h, a.br.x)
            }) : ((_ = o.addGroup({
          ...
          if (r.directionEnabled(l, "y")) {
            ...
            var I = n.getFieldRange(D, k, D.type),
              ...
              E = A / 2 + C;
            O ? O.get("children")[1].attr({
              y1: Math.max(a.tl.y + a.height * I[0] + P, a.tl.y),
              y2: Math.min(a.tl.y + a.height * I[1] + P, a.bl.y)
            }) : ((O = o.addGroup({
      ...
      l = function() {
        ...
        return e.renderLabels = function() {
          ...
          u.forEach(function(t) {
            ...
            o.isFunction(p) && C.addShape("Text", {
              attrs: o.mix({
                textBaseline: "bottom"
              }, P, p(v, x)),
              data: v,
              offsetY: y
            }), o.isFunction(g) && C.addShape("Text", {
              attrs: o.mix({
                textBaseline: "top"
              }, P, g(v, x)),
              data: v,
              offsetY: m
            }), b.textGroup = C, c.x < _.x ? (b._side = "left", l[0].push(b)) : (b._side = "right", l[1].push(b))
          });
          var b = [];
          if (v)
            for (var C, P = l[1].concat(l[0]), w = 0, M = P.length; w < M; w++) {
              ...
              l.forEach(function(e) {
                e.length > k && e.splice(k, e.length - k), e.sort(function(t, e) {
                  return t.y - e.y
                });
          ...
          this.labelGroup && this.labelGroup.clear(), this.halo && this.halo.remove(!0), this.lastSelectedData = null, this.drawnLabels = [], this.unBindEvents()
          ...
          for (var e, i = this, n = i.chart, r = i.drawnLabels, a = i.pieLabelCfg, s = a.onClick, c = a.activeShape, l = o.createEvent(t, n), u = l.x, h = l.y, f = 0, p = r.length; f < p; f++) {
            var g = r[f],
              d = g.getBBox();
            if (u >= d.minX && u <= d.maxX && h >= d.minY && h <= d.maxY) {
              e = g;
              break
            }
          }
          var v = n.getSnapRecords({
            x: u,
            y: h
          });
          ...
          return o.each(n, function(n) {
            if (n.get("isShape") && n.get("className") === i.get("type")) {
              ...
              if (o.isObjectValueEqual(r, t)) return e = n, !1
            }
          }), e
    ...
    t.exports = {
      init: function(t) {
        ...
        t.set("pieLabelController", i), t.pieLabel = function(t) {
          return t = o.deepMix({}, c, t), i.pieLabelCfg = t, this
        }
      },
      afterGeomDraw: function(t) {
    ...
    ! function(r, a, o, s) {
      ...
      function A(t) {
        ...
        return new(e || (Mt ? j : Tt ? H : wt ? q : z))(t, D)
      }
      ...
      function I(t, e) {
        var i = e.center,
          ...
          r = t.prevDelta || {},
          a = t.prevInput || {};
        e.eventType !== Dt && a.eventType !== It || (r = t.prevDelta = {
          x: a.deltaX || 0,
          y: a.deltaY || 0
        }, n = t.offsetDelta = {
          x: i.x,
      ...
      function F(t, e) {
        return t === e ? Et : xt(t) >= xt(e) ? t < 0 ? Yt : Bt : e < 0 ? Ft : Nt
      }
      ...
      function X(t, e) {
        return R(e[1], e[0], jt) + R(t[1], t[0], jt)
      }

      function L(t, e) {
        return N(e[0], e[1], jt) / N(t[0], t[1], jt)
      }

      function z() {
        this.evEl = Wt, this.evWin = Ht, this.pressed = !1, T.apply(this, arguments)
      }

      function j() {
        this.evEl = Ut, this.evWin = Zt, T.apply(this, arguments), this.store = this.manager.session.pointerEvents = []
      }

      function G() {
        this.evTarget = $t, this.evWin = Kt, this.started = !1, T.apply(this, arguments)
      }
      ...
      function U(t, e) {
        t & Dt ? (this.primaryTouch = e.changedPointers[0].identifier, Z.call(this, e)) : t & (It | Ot) && Z.call(this, e)
      }
      ...
      function Q(t) {
        this.options = gt({}, this.defaults, t || {}), this.id = w(), this.manager = null, this.options.enable = d(this.options.enable, !0), this.state = he, this.simultaneous = {}, this.requireFail = []
      }
      ...
      function et(t) {
        return t == Nt ? "down" : t == Ft ? "up" : t == Yt ? "left" : t == Bt ? "right" : ""
      }
      ...
      function ut(t, e) {
        return e = e || {}, e.recognizers = d(e.recognizers, ut.defaults.preset), new ht(t, e)
      }
      ...
      f(z, T, {
        handler: function(t) {
          var e = Gt[t.type];
          e & Dt && 0 === t.button && (this.pressed = !0), e & kt && 1 !== t.which && (e = It), this.pressed && (e & It && (this.pressed = !1), this.callback(this.manager, e, {
            pointers: [t],
            changedPointers: [t],
            pointerType: "mouse",
            srcEvent: t
      ...
      r.MSPointerEvent && !r.PointerEvent && (Ut = "MSPointerDown", Zt = "MSPointerMove MSPointerUp MSPointerCancel"), f(j, T, {
        handler: function(t) {
          ...
          r & Dt && (0 === t.button || o) ? s < 0 && (e.push(t), s = e.length - 1) : r & (It | Ot) && (i = !0), s < 0 || (e[s] = t, this.callback(this.manager, r, {
            pointers: e,
            changedPointers: [t],
            pointerType: a,
            srcEvent: t
      ...
      f(G, T, {
        handler: function(t) {
          ...
          if (e === Dt && (this.started = !0), this.started) {
            ...
            e & (It | Ot) && i[0].length - i[1].length == 0 && (this.started = !1), this.callback(this.manager, e, {
              pointers: i[0],
              changedPointers: i[1],
              pointerType: "touch",
              srcEvent: t
      ...
      Q.prototype = {
        ...
        requireFailure: function(t) {
          ...
          return t = it(t, this), -1 === S(e, t) && (e.push(t), t.requireFailure(this)), this
        },
        ...
        emit: function(t) {
          this.state === de && (t && t.eventType & It ? this.manager.emit(this.options.event + "up", t) : (this._input.timeStamp = _t(), this.manager.emit(this.options.event, this._input)))
        }
      }), f(st, nt, {
        defaults: {
          event: "rotate",
        ...
        attrTest: function(t) {
          ...
          return i & (Rt | Xt) ? e = t.overallVelocity : i & Rt ? e = t.overallVelocityX : i & Xt && (e = t.overallVelocityY), this._super.attrTest.call(this, t) && i & t.offsetDirection && t.distance > this.options.threshold && t.maxPointers == this.options.pointers && xt(e) > this.options.velocity && t.eventType & It
        },
        emit: function(t) {
        ...
        return i.getDefaultCfg = function() {
          ...
          if (t.attr(i), r.each(e, function(t) {
            ...
            r.each(f.get("children").concat(p.get("children")), function(t) {
              if (t.get("value") === l.scale(u[l.field])) return c = t, !1
    ...
    var a = i(0),
      ...
      f = function(t) {
        function e(e, i) {
          ...
          }]), a.mix(n(r), h, l, u), r._bindPress(), r
        }
        r(e, t);
        var i = e.prototype;
        return i.getDefaultCfg = function() {
          ...
          this.pressed || (this.currentDeltaX = 0, this.currentDeltaY = 0, "touchstart" !== t.type && "touchStart" !== t.type || (this.lastPoint = t.touches[0]), this._handleMove(t))
        }, i.process = function(t) {
          this.pressed || this._handleMove(t)
        }, i.end = function() {
          this.pressed || (this.currentDeltaX = null, this.currentDeltaY = null, this.lastPoint = null, this._panCumulativeDelta = 0)
        }, e
      }(o);
